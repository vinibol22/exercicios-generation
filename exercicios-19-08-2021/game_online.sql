...
select tb_personagem.nome,tb_personagem.sexo,tb_classe.decricao,tb_classe.pontosdeataque,tb_classe.pontosdedefesa,tb_classe.poderespecial from tb_personagem inner join tb_classe on tb_classe.id=tb_personagem.class_id;
